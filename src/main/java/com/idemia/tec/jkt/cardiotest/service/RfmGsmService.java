...
public class RfmGsmService {
    ...
    public StringBuilder generateRfmGsm(RfmGsm rfmGsm) {
        ...
        if (rfmGsm.isFullAccess()) {
            ...
            rfmGsmBuffer.append(
                ...
                + ".DEFINE %DF_ID " + root.getRunSettings().getCardParameters().getDfGsm() + "\n"
                + ".DEFINE %EF_ID " + rfmGsm.getCustomTargetEf() + "; EF protected by " + rfmGsm.getCustomTargetAcc() +  "\n"
                + ".DEFINE %EF_ID_ERR " + rfmGsm.getCustomTargetEfBadCase() + "; (negative test) EF protected by " + rfmGsm.getCustomTargetAccBadCase() +  "\n"
            );
        }
        rfmGsmBuffer.append(
            "\n.POWER_ON\n"
        ...
        if (root.getRunSettings().getSecretCodes().isUseIsc2())
            rfmGsmBuffer.append("A0 20 00 05 08 %" + root.getRunSettings().getSecretCodes().getIsc2() + " (9000)\n");
        if (root.getRunSettings().getSecretCodes().isUseIsc3())
            rfmGsmBuffer.append("A0 20 00 06 08 %" + root.getRunSettings().getSecretCodes().getIsc3() + " (9000)\n");
        if (root.getRunSettings().getSecretCodes().isUseIsc4())
            rfmGsmBuffer.append("A0 20 00 07 08 %" + root.getRunSettings().getSecretCodes().getIsc4() + " (9000)\n");
        rfmGsmBuffer.append(
        ...
        if (rfmGsm.isUseSpecificKeyset())
            rfmGsmBuffer.append(rfmGsmCase1(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
        else {
            for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                rfmGsmBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                rfmGsmBuffer.append(rfmGsmCase1(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
            }
        }
        rfmGsmBuffer.append("\n.UNDEFINE %EF_CONTENT\n");
        ...
        if (!rfmGsm.isFullAccess()) {
            rfmGsmBuffer.append(
                "\n; perform negative test: updating " + rfmGsm.getCustomTargetEfBadCase() + " (" + rfmGsm.getCustomTargetAccBadCase() + ")\n"
                + "\n.POWER_ON\n"
                + "; check initial content of EF\n"
                + "A0 20 00 00 08 %" + root.getRunSettings().getSecretCodes().getIsc1() + " (9000)\n"
            );
            ...
            rfmGsmBuffer.append(
                "A0 20 00 01 08 %" + root.getRunSettings().getSecretCodes().getChv1() + " (9000)\n"
                + "A0 20 00 02 08 %" + root.getRunSettings().getSecretCodes().getChv2() + " (9000)\n"
                + select2gWithAbsolutePath(rfmGsm.getCustomTargetEfBadCase())
                + "A0 B0 00 00 01 (9000)\n"
                + ".DEFINE %EF_CONTENT R\n"
            );
            if (rfmGsm.isUseSpecificKeyset())
                rfmGsmBuffer.append(rfmGsmCase1NegativeTest(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
            else {
                for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                    rfmGsmBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                    rfmGsmBuffer.append(rfmGsmCase1NegativeTest(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
                }
            }
            rfmGsmBuffer.append("\n.UNDEFINE %EF_CONTENT\n");
        }
        ...
        if (rfmGsm.isUseSpecificKeyset())
            rfmGsmBuffer.append(rfmGsmCase2(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
        else {
            for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                rfmGsmBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                rfmGsmBuffer.append(rfmGsmCase2(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
            }
        }
        // case 3
        ...
        if (rfmGsm.isUseSpecificKeyset())
            ...
            for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                rfmGsmBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                rfmGsmBuffer.append(rfmGsmCase3(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
            }
        }
        // case 4
        rfmGsmBuffer.append("\n*********\n; CASE 4: (Bad Case) use unknown TAR\n*********\n");
        if (rfmGsm.isUseSpecificKeyset())
            rfmGsmBuffer.append(rfmGsmCase4(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
        else {
            for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                rfmGsmBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                rfmGsmBuffer.append(rfmGsmCase4(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
            }
        }
        // case 5
        ...
        if (Integer.parseInt(rfmGsm.getMinimumSecurityLevel().getComputedMsl(), 16) < 16)
            ...
            if (rfmGsm.isUseSpecificKeyset())
                rfmGsmBuffer.append(rfmGsmCase5(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
            else {
                for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                    rfmGsmBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                    rfmGsmBuffer.append(rfmGsmCase5(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
                }
            }
        }
        // case 6
        ...
        if (rfmGsm.isUseSpecificKeyset())
            rfmGsmBuffer.append(rfmGsmCase6(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
        else {
            for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                rfmGsmBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                rfmGsmBuffer.append(rfmGsmCase6(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
            }
        }
        // case 7
        ...
        if (rfmGsm.getMinimumSecurityLevel().getComputedMsl().equals("00"))
            ...
            if (rfmGsm.isUseSpecificKeyset())
                rfmGsmBuffer.append(rfmGsmCase7(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), lowMsl));
            else {
                for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                    rfmGsmBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                    rfmGsmBuffer.append(rfmGsmCase7(keyset, keyset, lowMsl));
                }
            }
        }
        // case 8
    ...
    public StringBuilder generateRfmGsmUpdateRecord(RfmGsm rfmGsm) {
        ...
        if (root.getRunSettings().getSecretCodes().isUseIsc2())
            rfmGsmUpdateRecordBuffer.append("A0 20 00 05 08 %" + root.getRunSettings().getSecretCodes().getIsc2() + " (9000)\n");
        if (root.getRunSettings().getSecretCodes().isUseIsc3())
            rfmGsmUpdateRecordBuffer.append("A0 20 00 06 08 %" + root.getRunSettings().getSecretCodes().getIsc3() + " (9000)\n");
        if (root.getRunSettings().getSecretCodes().isUseIsc4())
            rfmGsmUpdateRecordBuffer.append("A0 20 00 07 08 %" + root.getRunSettings().getSecretCodes().getIsc4() + " (9000)\n");
        rfmGsmUpdateRecordBuffer.append(
                "A0 20 00 01 08 %" + root.getRunSettings().getSecretCodes().getChv1() + " (9000)\n"
                + "A0 20 00 02 08 %" + root.getRunSettings().getSecretCodes().getChv2() + " (9000)\n"
                + "A0 A4 00 00 02 %DF_ID (9F22)\n"
        ...
        // some TAR may be configured with specific keyset or use all available keysets
        if (rfmGsm.isUseSpecificKeyset())
            rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase1(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
        else {
            for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                rfmGsmUpdateRecordBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase1(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
            }
        }
        rfmGsmUpdateRecordBuffer.append("\n.UNDEFINE %EF_CONTENT\n");
        ...
        rfmGsmUpdateRecordBuffer.append("\n*********\n; CASE 2: (Bad Case) RFM with keyset which is not allowed in Gsm TAR\n*********\n");
        if (rfmGsm.isUseSpecificKeyset())
            rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase2(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
        else {
            for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                rfmGsmUpdateRecordBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase2(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
            }
        }
        ...
        rfmGsmUpdateRecordBuffer.append("\n*********\n; CASE 3: (Bad Case) send 3G command to GSM TAR\n*********\n");
        if (rfmGsm.isUseSpecificKeyset())
            rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase3(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
        else {
            for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                rfmGsmUpdateRecordBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase3(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
            }
        }
        ...
        rfmGsmUpdateRecordBuffer.append("\n*********\n; CASE 4: (Bad Case) use unknown TAR\n*********\n");
        if (rfmGsm.isUseSpecificKeyset())
            rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase4(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
        else {
            for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                rfmGsmUpdateRecordBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase4(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
            }
        }
        ...
        if (Integer.parseInt(rfmGsm.getMinimumSecurityLevel().getComputedMsl(), 16) < 16)
            ...
            if (rfmGsm.isUseSpecificKeyset())
                rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase5(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
            else {
                for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                    rfmGsmUpdateRecordBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                    rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase5(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
                }
            }
        }
        ...
        rfmGsmUpdateRecordBuffer.append("\n*********\n; CASE 6: (Bad Case) use bad key for authentication\n*********\n");
        if (rfmGsm.isUseSpecificKeyset())
            rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase6(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), rfmGsm.getMinimumSecurityLevel()));
        else {
            for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                rfmGsmUpdateRecordBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase6(keyset, keyset, rfmGsm.getMinimumSecurityLevel()));
            }
        }
        ...
        if (rfmGsm.getMinimumSecurityLevel().getComputedMsl().equals("00"))
            ...
            lowMsl.setCipherPor(false);
            if (rfmGsm.isUseSpecificKeyset())
                rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase7(rfmGsm.getCipheringKeyset(), rfmGsm.getAuthKeyset(), lowMsl));
            else {
                for (SCP80Keyset keyset : root.getRunSettings().getScp80Keysets()) {
                    rfmGsmUpdateRecordBuffer.append("\n; using keyset: " + keyset.getKeysetName() + "\n");
                    rfmGsmUpdateRecordBuffer.append(rfmGsmUpdateRecordCase7(keyset, keyset, lowMsl));
                }
            }
        }
    ...
    private String rfmGsmCase1(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
    ...
    private String rfmGsmCase1NegativeTest(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        routine.append(
            "\n.POWER_ON\n"
            + proactiveInitialization()
        ...
        routine.append(
            "\n; command(s) sent via OTA\n"
            + ".SET_BUFFER J A0 A4 00 00 02 %EF_ID_ERR ; select EF\n"
            + ".APPEND_SCRIPT J\n"
            + ".SET_BUFFER J A0 D6 00 00 <?> AA ; update binary\n"
            + ".APPEND_SCRIPT J\n"
            + ".END_MESSAGE G J\n"
            ...
            + ".CLEAR_SCRIPT\n"
            + "; check PoR\n"
            + "A0 C0 00 00 W(2;1) [XX XX XX XX XX XX %TAR XX XX XX XX XX XX 00 XX 98 04] (9000) ; PoR OK, but failed to update\n"
    ...
    private String rfmGsmCase2(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        routine.append(
            "\n.POWER_ON\n"
            + proactiveInitialization()
    ...
    private String rfmGsmCase3(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        routine.append(
            "\n.POWER_ON\n"
            + proactiveInitialization()
    ...
    private String rfmGsmCase4(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        routine.append(
            "\n.POWER_ON\n"
            + proactiveInitialization()
    ...
    private String rfmGsmCase5(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        routine.append(
            "\n.POWER_ON\n"
            + proactiveInitialization()
    ...
    private String rfmGsmCase6(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        routine.append(
            "\n.POWER_ON\n"
            + proactiveInitialization()
    ...
    private String rfmGsmCase7(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        routine.append(
            "\n.POWER_ON\n"
            + proactiveInitialization()
    ...
    private String rfmGsmUpdateRecordCase1(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        ...
        routine.append(
                ...
                + "; show OTA message details\n"
                + ".DISPLAY_MESSAGE J\n"
                + updateSMSRecordRfmGsm("rfmGsmUpdateRecordCase1")
                + "\n; check update has been done on EF\n"
                + ".POWER_ON\n"
                + "A0 20 00 00 08 %" + root.getRunSettings().getSecretCodes().getIsc1() + " (9000)\n"
        );
    ...
    private String rfmGsmUpdateRecordCase2(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        ...
        routine.append(
                ...
                + ".APPEND_SCRIPT J\n"
                + ".END_MESSAGE G J\n"
                + updateSMSRecordRfmGsm("rfmGsmUpdateRecordCase2")
                + "\n; increment counter by one\n"
                + ".INCREASE_BUFFER L(04:05) 0001\n"
        );
    ...
    private String rfmGsmUpdateRecordCase3(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        ...
        routine.append(
                ...
                + ".APPEND_SCRIPT J\n"
                + ".END_MESSAGE G J\n"
                + updateSMSRecordRfmGsm("rfmGsmUpdateRecordCase3")
                + "\n; increment counter by one\n"
                + ".INCREASE_BUFFER L(04:05) 0001\n"
        );
    ...
    private String rfmGsmUpdateRecordCase4(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
    ...
    private String rfmGsmUpdateRecordCase5(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        ...
        routine.append(
                ...
                + ".APPEND_SCRIPT J\n"
                + ".END_MESSAGE G J\n"
                + updateSMSRecordRfmGsm("rfmGsmUpdateRecordCase5")
                + "\n; increment counter by one\n"
                + ".INCREASE_BUFFER L(04:05) 0001\n"
        );
    ...
    private String rfmGsmUpdateRecordCase6(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        ...
        routine.append(
                ...
                + ".APPEND_SCRIPT J\n"
                + ".END_MESSAGE G J\n"
                + updateSMSRecordRfmGsm("rfmGsmUpdateRecordCase6")
                + "\n; increment counter by one\n"
                + ".INCREASE_BUFFER L(04:05) 0001\n"
        );
    ...
    private String rfmGsmUpdateRecordCase7(SCP80Keyset cipherKeyset, SCP80Keyset authKeyset, MinimumSecurityLevel msl) {
        StringBuilder routine = new StringBuilder();
        ...
        routine.append(
                ...
                + ".APPEND_SCRIPT J\n"
                + ".END_MESSAGE G J\n"
                + updateSMSRecordRfmGsm("rfmGsmUpdateRecordCase7")
                + "\n; increment counter by one\n"
                + ".INCREASE_BUFFER L(04:05) 0001\n"
        );
    ...
    private String updateSMSRecordRfmGsm(String rfmGsmCases) {
        ...
        updateSMSRecord.append(
                ...
                + "A0 B2 01 04 B0\n" // READ_SMS
                + "; check PoR\n"
                + "A0 12 00 00 W(2;1) [" + this.otaPorSettingRfmGsm(rfmGsmCases) + " ] (9000)\n"
