...
public class ScriptGeneratorServiceImpl implements ScriptGeneratorService {
    ...
    public StringBuilder generateRfmUsim(RfmUsim rfmUsim) {
        ...
        if (rfmUsim.isUseSpecificKeyset())
            ...
            rfmUsimBuffer.append(rfmUsimCase2(root.getRunSettings().getScp80Keysets().get(0), root.getRunSettings().getScp80Keysets().get(0), rfmUsim.getMinimumSecurityLevel())); // only use first keyset
        // case 3
        ...
        if (rfmUsim.isUseSpecificKeyset())
            ...
            rfmUsimBuffer.append(rfmUsimCase3(root.getRunSettings().getScp80Keysets().get(0), root.getRunSettings().getScp80Keysets().get(0), rfmUsim.getMinimumSecurityLevel())); // only use first keyset
        // case 4
        ...
        if (rfmUsim.isUseSpecificKeyset())
            ...
            rfmUsimBuffer.append(rfmUsimCase4(root.getRunSettings().getScp80Keysets().get(0), root.getRunSettings().getScp80Keysets().get(0), rfmUsim.getMinimumSecurityLevel())); // only use first keyset
        // case 5
        ...
        if (Integer.parseInt(rfmUsim.getMinimumSecurityLevel().getComputedMsl(), 16) < 16)
            ...
            if (rfmUsim.isUseSpecificKeyset())
                ...
                rfmUsimBuffer.append(rfmUsimCase5(root.getRunSettings().getScp80Keysets().get(0), root.getRunSettings().getScp80Keysets().get(0), rfmUsim.getMinimumSecurityLevel())); // only use first keyset
        }
        // case 6
        ...
        if (rfmUsim.isUseSpecificKeyset())
            ...
            rfmUsimBuffer.append(rfmUsimCase6(root.getRunSettings().getScp80Keysets().get(0), root.getRunSettings().getScp80Keysets().get(0), rfmUsim.getMinimumSecurityLevel())); // only use first keyset
        // case 7
        ...
        if (rfmUsim.getMinimumSecurityLevel().getComputedMsl().equals("00"))
            ...
            if (rfmUsim.isUseSpecificKeyset())
                ...
                rfmUsimBuffer.append(rfmUsimCase7(root.getRunSettings().getScp80Keysets().get(0), root.getRunSettings().getScp80Keysets().get(0), lowMsl)); // only use first keyset
        }
        // save counter
        rfmUsimBuffer.append(
            "\n; save counter state\n"
